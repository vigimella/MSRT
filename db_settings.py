...
with open('test.csv', 'r') as fin:
    ...
    to_db = [(i['Repo_Name'], i['Language'], i['Default_Branch'], i['Created_At'], i['Modified_At'], i['Size'], i['Stars'], i['Forks']) for i
             in dr]

for data in to_db:
    c.execute('INSERT INTO repository (repo_name, repo_language, main_branch, repo_creation, repo_modification, repo_size, '
